...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/teriyaki-tofu-bowl.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
                        <h1>Teriyaki Tofu</h1>
                    ...
                    <div class="deskmenu">
                        ...
                        Teriyaki tofu is a Japanese dish made with tofu that's been marinated and cooked in a flavorful teriyaki sauce. Tofu, a protein-rich soy product, is typically cut into cubes or slices and then gently pan-fried, grilled, or baked until it becomes slightly crispy on the outside while remaining tender on the inside.
                        </span>
                    </div>
                </div>
            </div>
