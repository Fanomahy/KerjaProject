...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/karaage-chicken-cup.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
...
Karaage chicken is a popular Japanese dish made of bite-sized pieces of marinated chicken that are coated in seasoned flour or potato starch and deep-fried until golden brown and crispy.

The marination process often involves soaking the chicken pieces in a mixture of soy sauce, garlic, ginger, and other seasonings, imparting a savory and aromatic flavor to the meat.

Once the chicken is coated with the seasoned flour or potato starch, it's deep-fried until it achieves a crispy exterior while remaining juicy and tender inside.
                        </span>
                    </div>
                </div>
            </div>
