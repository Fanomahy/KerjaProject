...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/Takoyaki.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
                        <h1>Takoyaki</h1>
                    ...
                    <div class="deskmenu">
                        ...
                        Takoyaki is a popular Japanese street food known for its savory octopus-filled batter balls. These bite-sized balls are made from a batter of flour, eggs, dashi (a type of stock), and finely chopped octopus.
                        </span>
                    </div>
                </div>
            </div>
