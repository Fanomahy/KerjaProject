...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/tempura-prawn.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
                        <h1>Tempura Prawn</h1>
                    ...
                    <div class="deskmenu">
                        ...
                        Tempura prawn is a Japanese dish featuring large prawns coated in a light, crispy batter and deep-fried until golden brown. The prawns are typically deveined and sometimes partially peeled, leaving the tail intact for presentation purposes.

The batter used in tempura prawns is made from a mixture of flour, water, and sometimes egg or other ingredients to create a light and airy coating. The prawns are then dipped in this batter and quickly deep-fried in hot oil until they become crispy on the outside while maintaining a tender and juicy texture inside.
                        </span>
                    </div>
                </div>
            </div>
