...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/caffe-latte-hot.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
                        <h1>Caffe Latte</h1>
...
A caffe latte is a coffee beverage made with espresso and steamed milk, topped with a small amount of milk foam. It's typically prepared using one-third espresso and two-thirds steamed milk, although the proportions can vary based on personal preference.

The espresso, which is a concentrated coffee brewed by forcing hot water through finely-ground coffee beans, forms the base of the drink. Steamed milk, heated to create a creamy texture, is then added to the espresso, providing a smooth and slightly creamy taste.
                        </span>
                    </div>
                </div>
            </div>
