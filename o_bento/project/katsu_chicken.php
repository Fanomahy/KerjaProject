...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/katsu-chicken-bowl.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
                        <h1>Katsu Chicken</h1>
                    ...
                    <div class="deskmenu">
                        ...
                        Katsu chicken is a Japanese dish that features a breaded and deep-fried chicken cutlet. The chicken is typically pounded thin, coated with flour, egg, and panko breadcrumbs, then fried until golden brown and crispy. This preparation method results in a crunchy exterior while keeping the chicken inside juicy and tender.
                        </span>
                    </div>
                </div>
            </div>
