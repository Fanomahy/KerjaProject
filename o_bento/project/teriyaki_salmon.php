...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/teriyaki-salmon-bowl.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
...
Teriyaki salmon is a Japanese dish featuring salmon fillets that are marinated and glazed in a sweet and savory teriyaki sauce before being grilled, broiled, or pan-seared. The teriyaki sauce typically consists of soy sauce, mirin (sweet rice wine), sugar, and sometimes ginger or garlic, creating a glossy and flavorful coating for the salmon.
                        </span>
                    </div>
                </div>
            </div>
