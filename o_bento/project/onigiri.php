...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/popular-onigiri.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
                        <h1>Onigiri</h1>
...
Onigiri is a traditional Japanese food that consists of seasoned rice formed into triangular or cylindrical shapes and often wrapped in nori (seaweed). These rice balls are typically filled with various ingredients, such as pickled plum (umeboshi), salted salmon, tuna, seaweed, or other savory fillings.
                        </span>
                    </div>
                </div>
            </div>
