...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/tempura-vege.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
                        <h1>Tempura Vege</h1>
                    ...
                    <div class="deskmenu">
                        <span>   
                        Tempura vegetables are a classic Japanese dish consisting of various vegetables coated in a light, crispy batter and deep-fried until they achieve a golden, crunchy exterior.

The vegetables commonly used in tempura can include slices of sweet potato, bell peppers, eggplant, zucchini, mushrooms, and green beans, among others. These vegetables are often cut into manageable pieces, dipped in a batter made from flour, water, and sometimes egg, then fried in hot oil until they're lightly crisp and cooked through
                        </span>
                    </div>
                </div>
            </div>
