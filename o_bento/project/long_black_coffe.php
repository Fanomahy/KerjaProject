...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/long-black-caffe.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
                        <h1>Long Black Coffe</h1>
                        <h3>ロングブラックコーヒー</h3>
                    </div>
...
Japanese cuisine is renowned for its use of fresh ingredients and unique balance of flavors. It often incorporates fresh fish, rice, and seaweed in dishes like sushi and sashimi. There's also ramen, a flavorful noodle soup, tempura featuring lightly battered and fried vegetables or seafood, and teriyaki known for its sweet and savory taste. Respecting food and presenting it beautifully are integral parts of Japanese culinary culture.
                        </span>
                    </div>
                </div>
            </div>
