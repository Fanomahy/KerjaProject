...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/katsu-curry-chicken-rice.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
                        <h1>Katsu Curry Chicken Rice</h1>
                        <h3>カツカレーチキンライス</h3>
                    </div>
                    ...
                    <div class="deskmenu">
                        ...
                        Katsu curry chicken rice is a Japanese dish consisting of breaded and deep-fried chicken cutlets (katsu) served with a rich, thick curry sauce, and accompanied by steamed rice. The chicken is typically coated in panko breadcrumbs before frying, resulting in a crispy exterior while maintaining a tender interior.
                        </span>
                    </div>
                </div>
            </div>
