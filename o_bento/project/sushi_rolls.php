...
<body>
    ...
    <main class="main">
        ...
        <section class="single_menu">
            <div class="row">
                <div class="column">
                    <img src="img/popular-sushi-rolls.png" alt="popular image">
                </div>
                <div class="column">
                    <div class="judulmenu">
                        <h1>Sushi Rolls</h1>
                    ...
                    <div class="deskmenu">
                        <span>   
                            Sushi roll is a Japanese dish consisting of rice rolled together with ingredients such as raw fish, seafood, vegetables, and sometimes eggs or fruits. 
                            The sushi rice used is typically mixed with rice vinegar, sugar, and salt, giving it a distinctive flavor. 
                            This roll is wrapped with nori, which is dried seaweed that adds a unique texture and flavor to the sushi.
                        </span>
                    </div>
                </div>
            </div>
